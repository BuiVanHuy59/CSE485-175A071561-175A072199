...
function register(){
	...
	$email       =  e($_POST['email']);
	$token = bin2hex(random_bytes(10)); // tạo mã thông báo duy nhất
...
function sendMail($email, $token){
	...
	$headers = "From: buihuy067@gmail.com";
	$txt = "Đây là link kích hoạt của bạn: http://localhost:81/BaiTapLonWeb/verify-email.php?token=$token";
